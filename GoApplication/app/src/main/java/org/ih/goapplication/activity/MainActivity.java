package org.ih.goapplication.activity;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Untuk menerima data dari put ectra
        ...
        Toast.makeText(getApplicationContext(), "welome"+usersucceslogin,Toast.LENGTH_SHORT).show();
